...
G.ENEMIES = {
  ...
  /* ---------- 魔物領（C〜Bランク Lv21-38） ---------- */
  minotaur:   { name:'ミノタウロス', icon:'🐂', lv:24, hp:1370, mp:20, atk:258, def:57, mag:218, res:40, spd:20,
  ...
  wraith:     { name:'レイス', icon:'👻', lv:26, hp:670, mp:180, atk:99, def:43, mag:84, res:68, spd:38,
  ...
  chimera:    { name:'キマイラ', icon:'🦁', lv:30, hp:2531, mp:120, atk:421, def:94, mag:356, res:54, spd:34,
  ...
  ice_queen:  { name:'氷結の魔女', icon:'❄️', lv:33, hp:1665, mp:300, atk:158, def:52, mag:168, res:80, spd:44,
  ...
  young_dragon:{name:'幼竜ワイバーン', icon:'🐉', lv:36, hp:2195, mp:160, atk:157, def:91, mag:167, res:74, spd:38,
  ...
  demon_soldier:{name:'魔族の兵士', icon:'😈', lv:38, hp:1190, mp:200, atk:112, def:81, mag:118, res:84, spd:48,
  ...
  /* ---------- 魔王領（A〜Sランク Lv40-55） ---------- */
  hell_hound: { name:'ヘルハウンド', icon:'🔥', lv:42, hp:1939, mp:180, atk:323, def:96, mag:342, res:107, spd:72,
  ...
  lich:       { name:'リッチ', icon:'☠️', lv:45, hp:1333, mp:600, atk:264, def:103, mag:276, res:138, spd:56,
  ...
  demon_knight:{name:'魔騎士', icon:'⚫', lv:48, hp:1568, mp:260, atk:288, def:110, mag:300, res:83, spd:66,
  ...
  archdemon:  { name:'上級魔族', icon:'👹', lv:52, hp:1999, mp:500, atk:303, def:118, mag:317, res:118, spd:78,
  ...
  /* ---------- ボス ---------- */
  boss_goblin_lord:{ name:'ゴブリンロード', icon:'👺', boss:true, lv:9, hp:378, mp:40, atk:29, def:24, mag:29, res:24, spd:14,
  ...
  boss_cave_guardian:{ name:'遺跡の守護者', icon:'🗿', boss:true, lv:18, hp:1757, mp:60, atk:82, def:44, mag:63, res:44, spd:12,
  ...
  boss_swamp_hydra:{ name:'沼のヒュドラ', icon:'🐍', boss:true, lv:28, hp:6329, mp:200, atk:384, def:66, mag:406, res:66, spd:30,
  ...
  boss_flame_dragon:{ name:'紅蓮竜イグナート', icon:'🐲', boss:true, lv:40, hp:6103, mp:400, atk:537, def:67, mag:560, res:74, spd:52,
  ...
  /* ---------- 魔王城 ---------- */
  gate_keeper:{ name:'門番ガルヴァス', icon:'🚪', boss:true, lv:46, hp:7679, mp:300, atk:1017, def:105, mag:1062, res:105, spd:50,
  ...
  four_general_1:{ name:'四天王・氷刃のセレス', icon:'🧊', boss:true, lv:50, hp:10480, mp:800, atk:1030, def:95, mag:1234, res:114, spd:88,
  ...
  four_general_2:{ name:'四天王・業火のバルガ', icon:'🌋', boss:true, lv:52, hp:13644, mp:500, atk:1200, def:118, mag:1426, res:97, spd:62,
  ...
  demon_lord_1:{ name:'魔王ヴァルドレア', icon:'😈', boss:true, lv:55, hp:18713, mp:1200, atk:918, def:125, mag:1153, res:125, spd:90,
  ...
  demon_lord_2:{ name:'真魔王ヴァルドレア', icon:'👑', boss:true, lv:60, hp:24625, mp:2000, atk:1002, def:136, mag:1242, res:136, spd:105,
