...
G.ITEMS = {
  ...
  /* ---------- 武器 ---------- */
  wood_stick:  { name:'木の枝',        type:'weapon', shape:'stick', icon:'🪵', price:0,     mods:{atk:2},              desc:'村を出る時に拾った枝。' },
  bronze_sword:{ name:'ブロンズソード', type:'weapon', shape:'sword', icon:'🗡️', price:320,   mods:{atk:12},            desc:'新人冒険者の定番。' },
  iron_sword:  { name:'アイアンソード', type:'weapon', shape:'sword', icon:'⚔️', price:1400,  mods:{atk:30},            desc:'手入れさえすれば長く使える。' },
  silver_sword:{ name:'シルバーソード', type:'weapon', shape:'sword', icon:'🤍', price:5200,  mods:{atk:58, res:8},     desc:'魔物に特効を持つ銀の刃。' },
  mithril_blade:{name:'ミスリルブレード',type:'weapon', shape:'sword',icon:'💎', price:16000, mods:{atk:95, spd:10},    desc:'軽く、硬く、折れない。' },
  flame_tongue:{ name:'フレイムタン',   type:'weapon', shape:'sword', icon:'🔥', price:32000, mods:{atk:130, mag:25},   el:'fire', desc:'刀身が常に燃えている。' },
  excalibur:   { name:'聖剣エクスカリバー',type:'weapon', shape:'sword',icon:'🌟',price:0, mods:{atk:210, mag:60, res:30}, el:'light', desc:'魔王を討つために鍛えられた選ばれし刃。', noShop:true, unique:true },

  oak_staff:   { name:'樫の杖',        type:'weapon', shape:'staff', icon:'🪄', price:300,   mods:{mag:12, mp:10},     desc:'学院の入学時に配られる杖。' },
  apprentice_wand:{name:'見習いの魔杖', type:'weapon', shape:'staff', icon:'✨', price:1300,  mods:{mag:28, mp:22},     desc:'魔力の通りが良い。' },
  crystal_rod: { name:'クリスタルロッド',type:'weapon', shape:'staff',icon:'🔮', price:5000,  mods:{mag:55, mp:45, res:10}, desc:'結晶が詠唱を増幅する。' },
  arch_staff:  { name:'大魔道の杖',    type:'weapon', shape:'staff', icon:'🌌', price:15500, mods:{mag:92, mp:80, res:20}, desc:'大魔道士に許される杖。' },
  world_tree_staff:{name:'世界樹の杖', type:'weapon', shape:'staff', icon:'🌳', price:31000, mods:{mag:135, mp:130, res:38}, desc:'尽きぬ魔力が宿る。' },

  cleric_mace: { name:'僧兵の錫杖',    type:'weapon', shape:'mace', icon:'📿', price:1200,  mods:{atk:18, mag:16},    desc:'祈りと打撃を兼ねる。' },
  holy_scepter:{ name:'聖別の錫杖',    type:'weapon', shape:'mace', icon:'🕯️', price:6000,  mods:{atk:34, mag:52, res:16}, desc:'不死を退ける聖具。' },

  bronze_dagger:{name:'ブロンズダガー', type:'weapon', shape:'dagger', icon:'🔪', price:280,   mods:{atk:9, spd:6},      desc:'素早さ重視の短刀。' },
  assassin_edge:{name:'アサシンエッジ', type:'weapon', shape:'dagger', icon:'🗝️', price:4800,  mods:{atk:48, spd:18},    desc:'刃に薄く毒が残っている。' },
  shadow_fang: { name:'影牙',          type:'weapon', shape:'dagger', icon:'♠️', price:18000, mods:{atk:100, spd:34},   desc:'影そのものを固めた双刃。' },
  hunting_bow: { name:'ハンティングボウ',type:'weapon', shape:'bow',icon:'🏹', price:1250,  mods:{atk:26, spd:10},    desc:'狩人の相棒。' },
  storm_bow:   { name:'ストームボウ',  type:'weapon', shape:'bow', icon:'🌪️', price:14000, mods:{atk:88, spd:26},    el:'wind', desc:'放った矢が風を裂く。' },
